...
export const services: Service[] = [
  ...
  },
  {
    slug: "deck-railings",
    name: "Deck Railings",
    title: "Deck Railing Installation & Replacement | Massachusetts",
    shortDescription:
      "Custom deck and stair railing systems in vinyl, wood, aluminum, and glass. Code-compliant, built to match your home, and installed clean around existing decking, stairs, and landing posts.",
    fullDescription:
      "A deck is only as good as its railing—and JT Fence Inc. builds railing systems that hold up to Massachusetts weather while keeping the view you paid for. We install and replace railings on new and existing decks throughout the South Shore, working with white vinyl for a clean maintenance-free look, natural or stained wood to match a cedar or clapboard home, black aluminum for a modern low-profile line, and glass or cable systems where an unobstructed sightline matters most. Every job starts with a look at your deck framing, post spacing, and stair layout so height, baluster spacing, and post placement meet current building code before a single bracket goes in. We coordinate with existing decking, coping, and stairs so the finished railing looks like it was always part of the house—not bolted on after the fact. Whether you're replacing a rotted or unsafe railing, finishing a new deck build, or upgrading old wood balusters to something lower-maintenance, we bring the same attention to plumb posts, tight joints, and secure hardware that homeowners expect from JT Fence Boston.",
    benefits: [
      "Code-compliant height and baluster spacing on every install",
      "Wide material selection—vinyl, wood, aluminum, glass, and cable",
      "Matches existing decking, siding, and home architecture",
      "Solves rotted, wobbly, or out-of-code older railings",
      "Low-maintenance options (vinyl, aluminum, glass) for busy homeowners",
      "Preserves sightlines with glass and cable systems where views matter",
      "Secure post-to-deck framing connections built for New England weather",
      "Clean integration with stairs, landings, and multi-level decks",
    ],
    bestUseCases: [
      "New deck builds needing a finished railing system",
      "Replacing rotted, loose, or out-of-code wood railings",
      "Upgrading an older deck to a low-maintenance material",
      "Homes with water, woods, or yard views worth preserving",
      "Multi-level decks and stair railings requiring code compliance",
      "Matching railing material to an existing fence for a unified look",
    ],
    styleOptions: [
      "White Vinyl Railing (Maintenance-free, classic look)",
    ...
    durabilityInfo:
      "Vinyl and aluminum railing systems typically last 20-30 years with virtually no upkeep, resisting rot, rust, and UV fade through New England winters. Wood railings last 15-20 years with regular sealing or staining. Glass and cable systems use marine-grade or powder-coated hardware rated for outdoor exposure, freeze-thaw cycles, and coastal salt air.",
    maintenanceInfo:
      "Vinyl and aluminum railings need only an occasional rinse to stay looking new—no painting or sealing required. Wood railings should be sealed or stained every 2-3 years like a wood fence. Glass panels wipe clean with standard glass cleaner, and cable systems should have tension checked annually. We recommend a yearly inspection of post connections and hardware on any railing system.",
    icon: "deck-railing",
    keywords: [
      "deck railing",
      "deck railings",
    ...
    priceRangeEstimate: "$40-90 per linear foot",
  },
];
